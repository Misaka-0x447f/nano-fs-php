...
class debugConsoleOpt{
    ...
    static public function err($string){
        if(error_reporting() != 0){
            ...
            debugConsoleOpt::toLogFileWithTimeStamp("Warning(Silenced by '@'): " . $string);
        }
        return true;
    }
